      ...
      <section className="mb-sm">
        ...
        >
          ...
          <div className="flex flex-col items-center max-w-lg mx-auto">
            ...
            <h3 className="font-title-section text-title-card font-semibold text-on-surface mb-xs">
              {uploading ? "Extracting Lab Metrics..." : fileName ? `Selected: ${fileName}` : "Upload Your Blood Report"}
            </h3>
            <p className="text-[13px] text-on-surface-variant mb-lg leading-relaxed">
              {uploading
